...
description: Create accurate, maintainable, task-oriented technical documentation that helps developers, operators, users and AI systems understand and use software correctly. Use when the user asks for documentation, README, API documentation, developer docs, technical writing, deployment guide, architecture documentation, user manual, changelog.
---
...
Create accurate, maintainable, task-oriented technical documentation that helps developers, operators, users and AI systems understand and use software correctly.
...
1. Identify the audience, task and prerequisite knowledge.
2. Inspect the actual code/configuration before documenting behavior.
3. Write task-oriented procedures with expected outcomes.
4. Keep reference material separate from tutorials and conceptual explanations.
5. Include examples that are executable or verifiable where practical.
6. Document failure modes and troubleshooting.
7. Cross-check commands, paths, API names and configuration against the implementation.
8. Update documentation whenever behavior changes.
